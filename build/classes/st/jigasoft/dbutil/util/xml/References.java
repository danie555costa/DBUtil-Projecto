...
public class References
{
    ...
    public References()
    {
        ...
        this.onUpgrad = (b) -> {if(b) this.upgraded = true;};
    }
     ...
     */
    void trasfer(ClassClass refClass, int indexTo)
    {
    ...
    /**
     * Percorrer em todas as classes da referencia
     * @param consumer 
     */
    void forEachRow(Consumer<ClassClass> consumer)
    {
        this.listClass.stream().forEach((clas) -> consumer.accept(clas));
    }
    ...
    public class ClassClass
    {
        ...
        void forEachRow(Consumer<FieldClass> consumer ) 
        {
            this.listField.stream().forEach((f) -> consumer.accept(f));
        }
    }

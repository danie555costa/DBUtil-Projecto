...
import st.jigasoft.dbutil.util.models.XMLClass;
...
import st.jigasoft.dbutil.util.xml.References.FieldClass;
...
public class XReference
{
     ...
     */
    public static void asXLM(Class <? extends XMLClass> refXmlClass, String xmlPach)
    {
        ...
        try
        {
            ...
            while(!referendeClass.equals(XMLClass.class)
                    && !referendeClass.equals(java.lang.Object.class))
            {
                listClass.add(0, referendeClass);
            ...
            for(int i =0  ; i< listClass.size(); i++)
            {
                ...
                for(Field field: fieldClass.getDeclaredFields())
                {
                   ...
                   //E POR ISSO ESSA VARIAVEIES NAO SERAO APRESENDADA SIMPLEMNETE COMO UM TRIBUTO
                    if(XMLClass.class.isAssignableFrom(fieldClass)&& 
                    ...
                    refField.validate();
                    refClass.transfer(refField, countField);
                    ...
                    if(field.getModifiers() == Modifier.PUBLIC+Modifier.STATIC)
                    {
                        ...
                        if(type.equals(java.lang.String.class))
                        {
                            ...
                            vall = (!hasXMLValue )? treatFieldName(field.getName())
                                    :xmlValue;
        ...
        {
            Logger.getLogger(XReference.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
     ...
     * @return 
     */
    private static Object treatFieldName(String name)
    {
        String newName = "";
